...
export default function CartPage() {
  ...
  return (
    <main className="relative overflow-hidden p-10 min-h-screen bg-gradient-to-b from-[#F8FAFC] via-[#F3F0FF] to-[#FFFFFF]">
            ...
            >
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                <button
                  ...
                  className="bg-[#8B5CF6] text-white px-3 py-1 rounded-lg hover:scale-105 transition"
                >
                  -
                </button>
                ...
                <button
                  ...
                  className="bg-[#6D28D9] text-white px-3 py-1 rounded-lg hover:scale-105 transition"
                >
                  +
                </button>
              ...
              <button
                ...
                className="mt-4 bg-[#EF4444] text-white px-4 py-2 rounded-xl hover:bg-red-700 transition"
              >
                Remove
              </button>
            </div>
...
>
  ← Continue Shopping
          ...
          <div className="mt-10 bg-white p-6 rounded-2xl shadow-md text-3xl font-bold text-[#6D28D9]">
            Total: ₹{totalPrice}
          </div>
        </>
      )}
